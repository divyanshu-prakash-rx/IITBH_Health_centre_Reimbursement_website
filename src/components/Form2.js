            ...
            >
                <div className="container ">
                    ...
                    <h5 className="text-center">
                        ...
                        in connection with medical attendance/treatment for members of
                        employees of the IIT Bhilai and their families.
                    </h5>
                    ...
                    <form action="/upload" method="post" enctype="multipart/form-data">
                        <div className="row ms-3 mb-4">
                            ...
                            <div className="col m-3">
                                <label className="mb-2" htmlFor="file">
                                    If dependent copy of dependent booklet
                                </label>
                                <input
                                    className="form-control mb-2 inpbox"
                                    type="file"
                    ...
                    <div
                        className=" bg-gradient p-3 mt-4"
                        style={{
                            borderRadius: "20px",
                    ...
                    <div class="ms-2">
                        <input
                            class="form-check-input mt-3 mb-1"
                            type="checkbox"
                            value=""
                            id="flexCheckDefault"
                        />
                        <label class="form-check-label" for="flexCheckDefault">
                            <p>
                                I hereby declare that the statement made in this application are
                                true to the best of my knowledge and belief/and that the person
                                for whom medical expenses were incurred is wholly dependent upon
                                me and is not an earning member of the family.{" "}
                            </p>
                        </label>
                    </div>
